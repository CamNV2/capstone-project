...
const LIMIT_OPTIONS = [
  { key: '1', value: 1, text: 'last items per page' },
  ...
  renderPaginator() {
    return (
      <Container style={{ display: 'flex' }}>
        <Container style={{ paddingBottom: '15px', textAlign: 'left' }}>
    ...
    return (
      <Item.Group divided>
        {this.state.todos.map((todo, pos) => {
          return (
            <Item>
              <Item.Image src={todo.attachmentUrl ? todo.attachmentUrl : ''} size="tiny" wrapped />
